                        ...
                        <div className="white-box">
                            ...
                            <div className="likes-section suggest">
                                <div className="img-area clearfix">
                                    ...
                                    <a href="#chat-bx" id="pop-right"> <img src="/client/assets/images/msg.png"
                                        className="img-responsive wd" /></a>
                                    <a href="#add-cont"> <img src="/client/assets/images/add-user.png" className="img-responsive wd" /></a>
                                </div>
                                <div className="img-area clearfix">
                                    <div className="img-c">
                                        <img src="/client/assets/images/user.png" className="img-responsive circled" />
                ...
                <div className="row">
                    ...
                    <div className="col-md-4 col-lg-3 position-relative" id="chat-bx">
                        <div className="popup" id="popup-r">
                            <div className="pop-header message-pop">
                                <a href="javascript:void(0)" id="hide-r" className="close-pop"><i className="fa fa-times"
                                    aria-hidden="true"></i></a>
                                <div className="user-im"><img src="/client/assets/images/user.png" className="img-responsive" />
                            ...
                            <div className="chat-area">
								...
								Would love to get together and knock

								out a couple of smash hits!


								Are you available next week?

							</div>
                                <b className="d-block text-right">Delivered</b>
                                <div className="w-ar">
                                    <div className="chat-bubble grey">
                                        Thanks Beaux!<br />


									I just checked out your stuff and you

									have a great voice! Especially love

									that acoustic song you have on your

									page...<br />


									Wanna get together and write?

								</div>
                                    <b className="d-block text-right">Just Now</b>
                                </div>
                                <div className="chat-bubble">

                                    Hey Tyler,<br />

								I listened to some of your tracks and

								you have a very unique sound!<br />
                        ...
                        <div className="input-space">
                            ...
                            <div className="env">
                                <i className="fa fa-envelope" aria-hidden="true"></i><span className="badge badge-primary">2</span>
                            </div>
                        </div>
                    </div>
