            ...
            <div className="white-box clearfix">
                ...
                <div className="desc-box networkStyling">
                    ...
                    {this.props.imageExist == true ? (<img src={"https://ochback.herokuapp.com/api/photo/" + this.props._id} width="100%" height="100%" className="img-responsive" />) : (
                        this.state.youtubeExist == true ? (<iframe style={{width: '100%', height: '300px'}} scrolling="no" frameborder="no" allow="autoplay" src={this.state.youtubeLink} allowfullscreen="allowfullscreen" mozallowfullscreen="mozallowfullscreen"
