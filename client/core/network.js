                    ...
                    <div className="row">
                        <div className="col-md-4 col-lg-3 position-relative" id="add-cont">
                            ...
                            <div className="input-space networkStyling">
                                ...
                                <input autoComplete="false" name="searchValue" type="text" value={this.state.searchValue} style={{ width: '92%' }} onChange={this.onSearch} onKeyDown={this._handleKeyDown} placeholder="Search NETWORK..." />
